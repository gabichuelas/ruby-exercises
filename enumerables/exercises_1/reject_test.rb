...
class RejectTest < Minitest::Test
  ...
  def test_remove_dinosaurs
    ...
    notasaurus = animals.reject { |word|
      word.match(/saurus/)}
  ...
  def test_remove_numbers
    ...
    not_numbers = elements.reject { |obj|
      obj.class == Integer || obj.class == Float }
